...
class TopScoresViewController: CoreDataTableViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        if fetchedResultsController!.sections!.count == 0 {
            let alertController = UIAlertController(title: "Notice", message: "You have not yet played and finished any challenges yet. Once you have they will be shown here", preferredStyle: UIAlertControllerStyle.Alert)
